 ...
 *
 */
public class StartRightEndScale extends SmartAutoChooserBase {
	...
	protected Command GetAutoroutine() {
    	...
    	if (scaleOnRight) {
    		// scale is near (N)
    		return new ScoreOnNearScaleEnd(Autonomous.StartOn.RIGHT);
    	} else {
    		// scale is opposite (O)
    		return new ScoreOnOppositeScaleEnd(Autonomous.StartOn.RIGHT);
    	}
