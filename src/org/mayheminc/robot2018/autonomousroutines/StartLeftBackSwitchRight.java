 ...
 *
 */
public class StartLeftBackSwitchRight extends CommandGroup {
    ...
    public StartLeftBackSwitchRight() {
		...
		// drive to the scale to straighten out
		addSequential(new DriveStraightOnHeading(-0.3, DistanceUnits.INCHES, 30.0, 0.0));
		// drive to the switch
		addSequential(new DriveStraightOnHeading(0.3, DistanceUnits.INCHES, 60.0, 180.0));
