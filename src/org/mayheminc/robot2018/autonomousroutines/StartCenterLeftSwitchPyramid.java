...
//    	addSequential(new ElevatorSetPosition(Elevator.SWITCH_HEIGHT));
    	...
    	addSequential(new DriveStraightOnHeading(0.8, DistanceUnits.INCHES, 30.0, 280.0)); // 40 on the right
...
//    	addParallel(new ElevatorArmSetMotorAuto(0.0));
    	...
    	addSequential(new DriveStraightOnHeading(0.5, DistanceUnits.INCHES, 20.0, 60.0)); // was .5 // was 300 for right
