...
//		addParallel(new DriveSetShifter(Shifter.HIGH_GEAR)); 
		...
		addSequential(new DriveStraightOnHeading(-0.5, DistanceUnits.INCHES, 70.0,      // was 60 on Day 1 of UNH; before was 45.0
				Autonomous.chooseAngle(startSide, 180.0)));

		// do final approach to scale in low gear to shed some speed
		addParallel(new DriveSetShifter(Shifter.LOW_GEAR)); 
		addSequential(new DriveStraightOnHeading(-0.3, DistanceUnits.INCHES, 25.0,      // was 60 on Day 1 of UNH; before was 45.0
				Autonomous.chooseAngle(startSide, 90.0)));
		
		addSequential(new DriveStraightOnHeading(0.3, DistanceUnits.INCHES, 50.0,      // was 60 on Day 1 of UNH; before was 45.0
				Autonomous.chooseAngle(startSide, 90.0)));
		
		addSequential(new DriveStraightOnHeading(-0.3, DistanceUnits.INCHES, 25.0,      // was 60 on Day 1 of UNH; before was 45.0
				Autonomous.chooseAngle(startSide, 0.0)));
