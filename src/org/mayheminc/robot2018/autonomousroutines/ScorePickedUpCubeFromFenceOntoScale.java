 ...
 *
 */
public class ScorePickedUpCubeFromFenceOntoScale extends CommandGroup {

    public ScorePickedUpCubeFromFenceOntoScale(Autonomous.StartOn startSide) {

    	// raise the elevator and turn the turret
    	addParallel(new ElevatorSetPosition(Elevator.SCALE_HIGH));
    	addParallel(new TurretMoveToDegree(Autonomous.chooseAngle(startSide, 190.0)));
